...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Metric.friendly_name'
        db.alter_column(u'metrics_metric', 'friendly_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

    def backwards(self, orm):

        # Changing field 'Metric.friendly_name'
        db.alter_column(u'metrics_metric', 'friendly_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
