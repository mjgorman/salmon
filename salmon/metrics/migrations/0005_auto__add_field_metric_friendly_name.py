...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Metric.friendly_name'
        db.add_column(u'metrics_metric', 'friendly_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Metric.friendly_name'
        db.delete_column(u'metrics_metric', 'friendly_name')
    ...
    models = {
        u'metrics.metric': {
            ...
            'friendly_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
